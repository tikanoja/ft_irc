...
/*   Updated: 2023/10/04 09:20:23 by djagusch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_NOORIGIN()(":" + servername + " 409 :No origin specified" + "\r\n") //409
# define ERR_NORECIPIENT(servername, command)(":" + servername + " 411 " +  ":No recipient given (" + command + ")" + "\r\n") //411
# define ERR_NOTEXTTOSEND()(":" + servername + " 412 :No text to send" + "\r\n") //412
...
# define ERR_NOMOTD()(":" + servername + " 422 :MOTD File is missing" + "\r\n") //422
...
# define ERR_SUMMONDISABLED()(":" + servername + " 445 :SUMMON has been disabled" + "\r\n") //445
# define ERR_USERSDISABLED()(":" + servername + " 446 :USERS has been disabled" + "\r\n") //446
...
# define ERR_NOPERMFORHOST()(":" + servername + " 463 :Your host isn't among the privileged" + "\r\n") //463
# define ERR_PASSWDMISMATCH()(":" + servername + " 464 :Password incorrect" + "\r\n") //464
# define ERR_YOUREBANNEDCREEP()(":" + servername + " 465 :You are banned from this server" + "\r\n") //465
# define ERR_YOUWILLBEBANNED()(":" + servername + " 466 " +  + "\r\n") //466
# define ERR_KEYSET(servername, channel)(":" + servername + " 467 " + channel + ":Channel key already set" + "\r\n") //467
# define ERR_CHANNELISFULL(servername, channel)(":" + servername + " 471 " + channel + ":Cannot join channel (+l)" + "\r\n") //471
...
# define ERR_NOPRIVILEGES()(":" + servername + " 481 " +  ":Permission Denied- You're not an IRC operator" + "\r\n") //481
# define ERR_CHANOPRIVSNEEDED(servername, channel)(":" + servername + " 482 " + channel + ":You're not channel operator" + "\r\n") //482
# define ERR_CANTKILLSERVER()(":" + servername + " 483 :You can't kill a server!" + "\r\n") //483
# define ERR_RESTRICTED()(":" + servername + " 484 :Your connection is restricted!" + "\r\n") //484
# define ERR_UNIQOPPRIVSNEEDED()(":" + servername + " 485 :You're not the original channel operator" + "\r\n") //485
# define ERR_NOOPERHOST()(":" + servername + " 491 :No O-lines for your host" + "\r\n") //491
# define ERR_UMODEUNKNOWNFLAG()(":" + servername + " 501 :Unknown MODE flag" + "\r\n") //501
# define ERR_USERSDONTMATCH()(":" + servername + " 502 :Cannot change mode for other users" + "\r\n") //502
