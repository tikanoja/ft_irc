...
/*   Updated: 2023/10/04 09:20:54 by djagusch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RPL_STATSOLINE()(":" + servername + " 243 (" + + "\r\n") //243 ??????
...
# define RPL_USERHOST()(":" + servername + " 302 (\r\n") //302 ??????
# define RPL_ISON()(":" + servername + " 303 (\r\n") //303 ??????????
# define RPL_UNAWAY()(":" + servername + " 305 (:You are no longer marked as being away\r\n") //305
# define RPL_NOWAWAY()(":" + servername + " 306 (:You have been marked as being away\r\n") //306
# define RPL_WHOISUSER(servername, nick, user, host, realname)(":" + servername + " 311 (" + nick + " " + user + " " + host + " * :" + realname + "\r\n") //311
# define RPL_WHOISSERVER()(":" + servername + " 312 (" + nick + " " + server + ":" + serverinfo + "\r\n") //312
# define RPL_WHOISOPERATOR(servername, nick)(":" + servername + " 313 (" + nick + " :is an IRC operator\r\n") //313
# define RPL_WHOWASUSER()(":" + servername + " 314 (" +  nick +  + " " + user + " " + host + " * :" + realname + "\r\n") //314 ??????
# define RPL_ENDOFWHO(servername, name)(":" + servername + " 315 (" + name + " :End of WHO list\r\n") //315
# define RPL_WHOISIDLE()(":" + servername + " 317 (" + nick + " " + integer + " :seconds idle\r\n") //317
# define RPL_ENDOFWHOIS()(":" + servername + " 318 (" + nick + " :End of WHOIS list\r\n") //318
# define RPL_WHOISCHANNELS()(":" + servername + " 319 (\r\n") //319 ?????
# define RPL_LIST(servername, channel, n_visible, topic)(":" + servername + " 322 (" + channel + " " + n_visible + " :" + topic + "\r\n") //322
# define RPL_LISTEND()(":" + servername + " 323 (:End of LIST\r\n") //323
...
# define RPL_WHOREPLY()(":" + servername + " 352 (\r\n") //352 ??????
# define RPL_NAMREPLY()(":" + servername + " 353 (\r\n") //353 ???????
...
# define RPL_ENDOFBANLIST()(":" + servername + " 368 (\r\n") //368
# define RPL_ENDOFWHOWAS()(":" + servername + " 369 (" + nick + " :End of WHOWAS\r\n") //369
# define RPL_INFO(servername, string)(":" + servername + " 371 (:" + string + "\r\n") //371
# define RPL_MOTD()(":" + servername + " 372 (:- " + text + "\r\n") //372
# define RPL_ENDOFINFO()(":" + servername + " 374 (:End of INFO list\r\n") //374
# define RPL_MOTDSTART()(":" + servername + " 375 (:- " + server + " Message of the day - \r\n") //375
# define RPL_ENDOFMOTD()(":" + servername + " 376 (:End of MOTD command\r\n") //376
# define RPL_YOUREOPER()(":" + servername + " 381 (:You are now an IRC operator\r\n") //381
# define RPL_REHASHING()(":" + servername + " 382 (" + config + "file :Rehashing\r\n") //382
# define RPL_YOURESERVICE(servername, servicename)(":" + servername + " 383 (You are service " + servicename + "\r\n") //383
# define RPL_MYPORTIS()(":" + servername + " 384 (\r\n") //384
# define RPL_TIME(servername, server, localtime)(":" + servername + " 391 (" + server + " :" + localtime + "\r\n") //391
# define RPL_USERSSTART()(":" + servername + " 392 (:UserID Terminal  Host\r\n") //392
# define RPL_USERS(servername, userbame, ttyline, hostname)(":" + servername + " 393 (:" + username + " " + ttyline + " " + hostname + "\r\n") //393
# define RPL_ENDOFUSERS()(":" + servername + " 394 (:End of users\r\n") //394
# define RPL_NOUSERS()(":" + servername + " 395 (:Nobody logged in\r\n") //395
