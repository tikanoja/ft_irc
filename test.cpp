...
int main(){
	...
	user.setNick("DudeMcDud");
	user.setUserName("DudeMcDudeface");
	user.setRealName("Dude Duderton");
	std::cout << user << std::endl;
	user.setMode(static_cast<IRCServer::e_uperm>(0x0080));
	server.printModeStr(user);
	std::cout << user << std::endl;
	user.setMode(static_cast<IRCServer::e_uperm>(0x0002));
	server.printModeStr(user);
	std::cout << user << std::endl;
	user.setMode(static_cast<IRCServer::e_uperm>(0x0001));
	server.printModeStr(user);
	std::cout << user << std::endl;
